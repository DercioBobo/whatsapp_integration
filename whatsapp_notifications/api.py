...
def send_whatsapp(phone, message, doctype=None, docname=None, queue=True):
    ...
    from whatsapp_notifications.doctype.doctype.whatsapp_message_log.whatsapp_message_log import create_message_log
...
def get_notification_stats():
    ...
    Returns:
        dict: Statistics
    """
    from whatsapp_notifications.doctype.doctype.whatsapp_message_log.whatsapp_message_log import get_message_stats
